...
Current HomeSeer version: **HS4 4.1.16.0**
...
`buzzec/docker-homeseer4:latest`: See below for descriptions of available image tags.
...
`docker pull buzzec/docker-homeseer4`
...
This was then forked from @E1iTeDa357's repo to be updated.
